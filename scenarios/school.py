    ...
    if (dist<70):
        ...
        for i in range(NUMBER_OF_STUDENT_IN_RIGHT):
            for j in range(i):
                ...
                walker_transform=carla.Transform(carla.Location(x=-79+j,y=-97+(NUMBER_OF_STUDENT_IN_RIGHT-i), z= 1.438 ),carla.Rotation(yaw= 1.4203450679814286772))
                ...
                if(walker!=None):
                    ...
                    walker_heading = -270+(i+j-3)*5*((-1)**i) # near scl

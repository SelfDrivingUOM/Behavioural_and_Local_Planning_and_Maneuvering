...
class World(object):
    def __init__(self, carla_world, hud, args):
        ...
        self.args = args
        self.actor_role_name = self.args.rolename
        try:
        ...
        self._actor_filter = self.args.filter
    ...
    def restart(self):
        ...
        if blueprint.has_attribute('speed'):
            ...
            print("self.player_max_speed_fast ",self.player_max_speed_fast)
        else:
        ...
        if self.player is not None:
            ...
            self.destroy()
            if self.args.xcell==None or self.args.ycell==None:
                self.player = self.world.try_spawn_actor(blueprint, spawn_point)
            ##################################################################
            else:
                self.player = hf.custom_spawn_actor(self.world, [], blueprint, self.args.xcell, self.args.ycell,
                                                self.args.psi, hf.grid_resolution,
                                                offsets=(self.args.offsets[0], self.args.offsets[1]))
        else:
            if self.args.xcell==None or self.args.ycell==None:
            ...
            ##################################################################
                ...
                if self.player is None:
                    print("Invalid spawn point given by the user!")
                    sys.exit(1)
...
def main():
    ...
    argparser.add_argument(
        ...
        type=int,
        # required=True,
        help="desired x cell no.")
    argparser.add_argument(
        '--ycell','-y',
        action='store',
        type=int,
        # required=True,
        help="desired y cell no.")
    argparser.add_argument(
        '--psi',
        action='store',
        type=float,
        required=False,
        default=0,
        help="optional yaw angle in degrees, default 0")
    argparser.add_argument(
        '--offsets','-o',
        action='store',
        type=float,
